...
const ContactPage = () => {
	console.log(process.env.CLIENT_EMAIL_ADDRESS, process.env.CLIENT_PHONE_NUMBER)
	...
	<Layout>
		...
		<section id="contact-section" className="sans-serif mw7 center">
			...
			<p className="lh-copy mb2">
				Either give us a call at <a className="b" href={clientPhoneNumRef}>{clientPhoneNumStr}</a> or fill out the form below and we'll get back to you as soon as we can!
			</p>
			<article className="sans-serif">
				<form action={formActionStr} method="POST">
					<fieldset id="sign_up" className="ba b--transparent ph0 mh0">
						...
						<div className="mt3">
							<label className="db fw5 mb1 lh-copy f6" htmlFor="email-address">
								Email address
							</label>
							<input
								className="pa2 input-reset ba bg-transparent w-100 measure br1"
